...
def make_classifier(num_classes, final_features):

    lst = [nn.Linear(final_features, num_classes)]

    return nn.Sequential(*lst)

class VGG(nn.Module):

    def __init__(self, features, num_classes=1000, pruned_arch='Taylor1000', applymask=False):
        super(VGG, self).__init__()
        self.features = features
        self.num_classes = num_classes
        final_features = features[-3].num_features
